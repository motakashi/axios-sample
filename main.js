...
var ApplicationId = require('./applicationId');
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var method, url, jsonFile, response, _a, url_1, err_1;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    _b.trys.push([1, 3, , 4]);
                    url_1 = "https://map.yahooapis.jp/search/zip/V1/zipCodeSearch?query=105-0011&output=json&appid=" + ApplicationId.getID;
...
function postJsonFile(url, jsonFile) {
    fs_1.default.readFile(jsonFile, function (err, data) {
        return __awaiter(this, void 0, void 0, function () {
            var options, err_2;
